          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="p-8">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">{data.coverLetter}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                ...
                <div>
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm font-medium text-gray-500">Applied By</span>
                  </div>
                  <p className="text-gray-900 font-semibold">{data.user?.name}</p>
                </div>
              </div>
            </div>
          </div>
